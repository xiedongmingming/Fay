...
def submit_request(query, temperature, topP, topK, max_tokens, engine, frequencyPenalty, responsePenalty,
                   noRepeatNgramSize):
    ...
    url = SUBMIT_URL + "engine={0}&account={1}&data={2}&temperature={3}&topP={4}&topK={5}&tokensToGenerate={6}" \
        ...
        format(engine, ACCOUNT, query, temperature, topP, topK, max_tokens, "api", frequencyPenalty, responsePenalty,
               noRepeatNgramSize)
